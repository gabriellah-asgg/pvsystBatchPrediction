...
json_filepath = r"../res/effsysr_data/effsysr_cache.json"
target = "EffSysR %"

# construct dataframe for model building
filepath = r'Q:\Projects\224008\DESIGN\ANALYSIS\00_PV\PVsyst Batch Simulation\effsysr_data.xlsx'
...
model_builder.run_model_builder(model_params, "effsysr_data", json_filepath)