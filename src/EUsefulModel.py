...
json_filepath = r"../res/euseful_data/euseful_cache.json"
target = "EUseful (KWh)"

# construct dataframe for model building
filepath = r'Q:\Projects\224008\DESIGN\ANALYSIS\00_PV\PVsyst Batch Simulation\euseful_data.xlsx'
...
model_builder.run_model_builder(model_params, "euseful_data", json_filepath)