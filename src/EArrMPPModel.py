...
json_filepath = r"../res/earrmpp_data/earrmpp_cache.json"
target = "EArrMpp (KWh)"

# construct dataframe for model building
filepath = r'Q:\Projects\224008\DESIGN\ANALYSIS\00_PV\PVsyst Batch Simulation\earrmpp_data.xlsx'
...
model_builder.run_model_builder(model_params, "earrmpp_data", json_filepath)