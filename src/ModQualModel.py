...
json_filepath = r"../res/modqual_data/modqual_cache.json"
target = "ModQual (KWh)"

# construct dataframe for model building
filepath = r'Q:\Projects\224008\DESIGN\ANALYSIS\00_PV\PVsyst Batch Simulation\modqual_data.xlsx'
...
model_builder.run_model_builder(model_params, "modqual_data", json_filepath)