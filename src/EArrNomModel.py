...
json_filepath = r"../res/earrnom_data/earrnom_cache.json"
target = "EArrNom (KWh)"

# construct dataframe for model building
filepath = r'Q:\Projects\224008\DESIGN\ANALYSIS\00_PV\PVsyst Batch Simulation\earrnom_data.xlsx'
...
for model in model_params.keys():
    ...
    if not skip_model:
        if 'tuned' in model:
            ...
            export = add_model_params(pv_type, curr_param, model, rmse_score, si_score, best_params, filepath=json_filepath)
