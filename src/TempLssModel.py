...
json_filepath = r"../res/templss_data/templss_cache.json"
target = "TempLss (KWh)"

# construct dataframe for model building
filepath = r'Q:\Projects\224008\DESIGN\ANALYSIS\00_PV\PVsyst Batch Simulation\templss_data.xlsx'
...
model_builder.run_model_builder(model_params, "templss_data", json_filepath)